...
### M9 — Optional: React front-end
Only if time remains. Vite + React app in `frontend/`, built into `static/` by a CI step; API unchanged. Not planned in detail on purpose.
